# recall-showcase-notes

Public-facing **Recall System** landing: marketing home plus an **Engineering notes** page (`/engineering-notes`). This repository is the standalone Vite app copied from the monorepo’s `apps/landing` so it can be published independently.
